...
acticles = [
    Article(id=1, author=users[0], title='Article1', text='TextArticle1 '*10),
    Article(id=2, author=users[0], title='Article2', text='TextArticle2 '*10),
    Article(id=3, author=users[1], title='Article3', text='TextArticle3 '*10),
    Article(id=4, author=users[1], title='Article4', text='TextArticle4 '*10),
    Article(id=5, author=users[2], title='Article5', text='TextArticle5 '*10),
